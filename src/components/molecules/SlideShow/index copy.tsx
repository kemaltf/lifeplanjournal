...
const Index = ({ currentImage, setCurrentImage }): JSX.Element => {
  ...
  return (
    <ContainerStyled>
      ...
      >
        <Image src={images[images.length - 1]} key={-1} alt="" width={500} height={500} layout="responsive"></Image>
        ...
        <Image src={images[0]} key={images.length} alt="" width={500} height={500} layout="responsive"></Image>
      </SlideContent>
      <ArrowButtonRight>
